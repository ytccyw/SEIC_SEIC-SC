function labels = Tcut_for_bipartite_graph(B,Nseg)
...
[vec,~] = eigs(nWy,Nseg);clear nWy
Ncut_evec = D*vec;clear D
...
labels = litekmeans(evec,Nseg,'MaxIter',100,'Replicates',10,'Distance','cosine');